...
void sort_period_rise(int [], int, int);
...
int main() {
    ...
    sort_period_rise(mas, index1, index2);
    cout << "Massive after sorting from the lowest to highest from index: " << index1+1 << " to index " << index2+1 <<": " << endl;
    show_massive(mas, N);
...
void sort_period_rise(int array[], int index1, int index2){
